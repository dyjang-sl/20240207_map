...
(function() {
  ...
  if (!raw) {
	  console.log("if");
    document.write('<scr' + 'ipt type="text/javascript" src="/openlayers/build/ol.js"></scr' + 'ipt>');
  } else {
	  console.log("else");
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="/openlayers/closure-library/closure/goog/base.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="/openlayers/build/ol-deps.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="/openlayers/script/' + scriptId + '-require.js"></scr' + 'ipt>');
  }
  // document.write('<scr' + 'ipt type="text/javascript" src="/openlayers/script/' + scriptId + '.js"></scr' + 'ipt>');
}());
